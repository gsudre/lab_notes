...
So, if we only check the subjects that have some clinical, out of the ones with good data, there is no correlation between movement and mean variables. But since we're only worried about later assessments, let's dig further:
